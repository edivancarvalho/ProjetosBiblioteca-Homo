 ...
 * @author edivan
 */
public class AcervosLivros extends javax.swing.JFrame {

    /**
     * Creates new form AcervosLivros
     */
    public AcervosLivros() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Cadastro de Acervos e Livros"));
        ...
        jLabel3.setText("Preco de Compra");

        jLabel4.setText("ISBN");

        jLabel5.setText("Status");

        jLabel6.setText("Motivo desativado");

        jLabel8.setText("Data de Aquisição");

        jCheckBox1.setText("Seleção");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AcervosLivros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AcervosLivros().setVisible(true);
            }
        });
    }
